...
public class PlaceAdapter extends RecyclerView.Adapter<MyViewHolder>{
    ...
    private List<PDataClass> dataList;

    // Constructor for dataList
    public PlaceAdapter(Context context, List<PDataClass> dataList) {
    ...
    public void searchDataList(ArrayList<PDataClass> searchList){
        dataList = searchList;
